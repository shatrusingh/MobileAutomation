...
public class TestBase {
	...
	public void getbrowser(String browser){
		...
		if(System.getProperty("os.name").contains("Window")){
			...
			System.out.println(System.getProperty("user.dir"));
				System.setProperty("Webdriver.geco.driver",System.getProperty("user.dir")+"/drivers/geckodriver");
				...
				System.out.println(System.getProperty("user.dir"));	
				System.setProperty("Webdriver.geco.driver",System.getProperty("user.dir")+"/drivers/chromedriver");
	...
	public void propertiesfileLoad() throws IOException
	{
		String log4jConfPath = "log4j.properties";
		PropertyConfigurator.configure(log4jConfPath);
		
		OR = new Properties();
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/Appium/config/config.properties");
		file = new FileInputStream(f1);
		OR.load(file);
			
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/com/Appium/config/or.properties");
	    file = new FileInputStream(f1);
		OR.load(file);
	...
	public WebElement Waitforpollinginterval(WebDriver driver,long time,WebElement element)
	{
		WebDriverWait wait = new WebDriverWait(driver,time);
